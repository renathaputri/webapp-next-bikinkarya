  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto max-w-5xl px-4 py-16">
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="h-24 w-24 rounded-full bg-secondary flex items-center justify-center font-bold text-3xl border border-border shadow-sm mb-6">
            {user.username.charAt(0).toUpperCase()}
          </div>
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">
            Hi, I'm <span className="text-primary">{user.username}</span>
          </h1>
          <p className="text-xl text-muted-foreground mb-6 capitalize">
